...
\033[1;90m [ AAMAN X KHALIFA ]

\x1b[1;92m=============================
\x1b[1;93m Coder + Author iS : AAMAN TAHIR X MIN KHALIFA
\x1b[1;93m FAMILY  : DADDY KILLER GANG (RMU)UNITY
\x1b[1;93m FaceBook : AAMAN TAHIR
\x1b[1;93m Whatsapp:  +92316 4126500
...
CorrectUsername = "RMU"
CorrectPassword = "AAMAN X MIN KHALIFA"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Aaman x Mia Khalifa
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;92m         [ RMU X MIAN { Pak Hacker } ]"
	print
